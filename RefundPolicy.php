...
$query=mysql_query("select * from refundpolicy");
$result=mysql_fetch_array($query);

if(isset($_POST['update'])){

		$query=mysql_query("update refundpolicy set policy='".$_POST['policy']."' where id='".$_POST['id']."'"  );
		if($query){
				?> <script>alert("Refundpolicy successfully updated "); window.location.assign("http://takemyviews.com/CRM/RefundPolicy.php");</script><?php
			}
		else{
