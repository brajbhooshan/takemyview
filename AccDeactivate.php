...
//echo '<pre>';print_r($_SESSION);die;
	...
	{
	$sql="select * from account where deactivate='yes'";
	}
	//for user
	else{
	$sql="select * from account where deactivate='yes' and user_id='".$_SESSION['user_id']."'";
	}
		...
		<div class="main-content">
			...
			<div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Deactivated History</h3>
